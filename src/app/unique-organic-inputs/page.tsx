      ...
      <main>
        ...
        <section className="relative h-[95vh] flex items-end justify-center text-white">
          ...
          <div className="container mx-auto px-4 relative z-10 px-[100px] pb-20">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Proprietary Organic Inputs</h1>
            <h2 className="text-2xl md:text-4xl font-bold mb-6">Proprietary Solutions Crafted In-House</h2>
          </div>
        </section>
