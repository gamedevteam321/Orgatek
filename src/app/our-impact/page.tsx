...
export default function OurImpactPage() {
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative h-[600px] w-full -ml-8">
        <Image
        ...
        <div className="absolute inset-0 bg-black/50 flex items-end justify-start p-8 md:p-16">
          <h1 className="text-5xl font-bold text-white max-w-2xl">Our Impact: Driving Carbon Removal and Rural Resilience</h1>
        </div>
      </section>

      {/* Environmental Impact Section */}
      <section className="py-20 px-20 mx-auto">
      ...
      <section className="py-20 bg-gray-50">
        <div className="px-20 mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8">Empowering Communities. Empowering People. Building Futures.</h2>
